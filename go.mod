...
require (
	...
	github.com/grafana/pyroscope-go/godeltaprof v0.1.8 // this should be indirect, but we should do this to fix https://github.com/grafana/pyroscope-go/issues/117
